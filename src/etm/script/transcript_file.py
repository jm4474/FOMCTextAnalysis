...
# Do Separation
sep_rules = pd.read_excel("util_files/separation_part2.xlsx", dtype={"date": str},encoding='utf-8-sig')
...
newdata.to_excel("util_files/raw_text_part2.xlsx")
newdata.to_pickle("util_files/raw_text_part2.pkl")
