...
def etm(dataset,data_path,emb_path,save_path= '',
    ...
    args.t_hidden_size = t_hidden_size #', type=int, default=800, help='dimension of hidden space of q(theta)')
    args.theta_act = theta_act #', type=str, default='relu', help='tanh, softplus, relu, rrelu, leakyrelu, elu, selu, glu)')
    ...
    args.optimizer = optimizer #', type=int, default=2019, help='random seed (default: 1)')
    ...
    ## get data
    # 1. vocabulary
    vocab, train, valid, test, traincov, validcov, testcov = data.get_datacov(os.path.join(args.data_path))
    ...
    model = ETMCOV(args.num_topics, vocab_size, args.t_hidden_size, args.rho_size, args.emb_size,
