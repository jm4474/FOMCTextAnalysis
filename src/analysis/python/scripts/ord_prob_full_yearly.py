...
def main():
	...
	second_sample = ['l1_ld_inflation_yearly','l1_diff_unemp_yearly',
				'lag_DFEDTAR','target_change_last','target_change_last_fomc',
	...
	menu_df = s_df[['d_menu_adj_m050', \
		...
		'd_menu_adj_050']]
	menu_df.to_csv("../../matlab/data/full_controls_yearly_ord_prob_p1_menu.csv",index=False)
	x_df.to_csv("../../matlab/data/full_controls_yearly_ord_prob_p1.csv",index=False)
	out_df.to_csv("../../matlab/data/full_controls_yearly_targets_ord_prob_p1.csv",index=False)
	print(x_df.columns)
