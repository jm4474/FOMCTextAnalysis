...
def main():
	...
	first_test = ['l1_ld_inflation_quarterly','l1_diff_unemp_quarterly']
	...
	menu_df = s_df[['date_m','d_menu_adj_m050', \
		...
		'd_menu_adj_050']]
	menu_df.to_csv("../../matlab/data/simple_controls_quarterly_ord_prob_p1_menu.csv",index=False)
	x_df.to_csv("../../matlab/data/simple_controls_quarterly_ord_prob_p1.csv",index=False)
	out_df.to_csv("../../matlab/data/simple_controls_quarterly_targets_ord_prob_p1.csv",index=False)
