...
=======
    ax_1.scatter(x=u_df["lagged_reduced_ind_pro"],y=u_df['l1_ld_inflation_yearly'],c="blue",label="unchanged")
    
>>>>>>> 0a785040b8ba611504533b1a8c5d446382c4840a
    ...
    plt.axvline()
    plt.legend()
    plt.title("Outcomes plotted by conditions")
    plt.show()
