...
def main():
	...
	first_test = ['l1_ld_inflation_yearly','l1_diff_unemp_yearly']
	...
	menu_df = s_df[['date_m','d_menu_adj_m050', \
		...
		'd_menu_adj_050']]
	menu_df.to_csv("../../matlab/data/simple_controls_yearly_ord_prob_p1_menu.csv",index=False)
	x_df.to_csv("../../matlab/data/simple_controls_yearly_ord_prob_p1.csv",index=False)
	out_df.to_csv("../../matlab/data/simple_controls_yearly_targets_ord_prob_p1.csv",index=False)
